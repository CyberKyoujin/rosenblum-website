...
var Slider = React48.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime27.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime27.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5STC2NMI.js.map
