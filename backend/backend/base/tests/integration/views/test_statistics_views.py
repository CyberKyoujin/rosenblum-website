...
class TestDashboardStatsView:
    ...
    def test_returns_total_orders(self, admin_client, create_order):
    ...
    def test_returns_new_orders_count(self, admin_client, create_order):
    ...
    def test_no_auth_required(self, admin_client, create_order):
...
class TestOrderStatusDistributionView:
    ...
    def test_returns_status_distribution(self, admin_client, create_order):
        ...
        response = admin_client.get('/api/statistics/status-distribution/')
    ...
    def test_returns_german_labels(self, admin_client, create_order):
    ...
    def test_empty_database_returns_empty_list(self, admin_client):
    ...
    def test_all_statuses_have_correct_format(self, admin_client, create_order):
...
class TestOrderDynamicsView:
    ...
    def test_returns_monthly_order_counts(self, admin_client, create_order):
        """Test returns orders grouped by month"""
        create_order()
        create_order()

        response = admin_client.get('/api/statistics/ordering-dynamics/')
    ...
    def test_only_includes_last_year(self, admin_client, db):
    ...
    def test_returns_period_and_count(self, admin_client, create_order):
...
class TestOrderTypeDistributionView:
    ...
    def test_returns_type_distribution(self, admin_client, create_order):
        """Test returns order counts by type"""
        create_order(order_type='order')
        create_order(order_type='order')
        create_order(order_type='costs_estimate')

        response = admin_client.get('/api/statistics/type-distribution/')
    ...
    def test_counts_each_type(self, admin_client, create_order):
...
class TestGeographyStatsView:
    ...
    def test_returns_top_cities(self, admin_client, create_order):
        """Test returns top 10 cities by order count"""
        create_order(city='Berlin')
        create_order(city='Berlin')
        create_order(city='Munich')

        response = admin_client.get('/api/statistics/customers-geography/')
    ...
    def test_cities_sorted_by_count(self, admin_client, create_order):
    ...
    def test_excludes_empty_cities(self, admin_client, create_order):
    ...
    def test_limits_to_10_cities(self, admin_client, create_order):
...
class TestUserGrowthView:
    ...
    def test_returns_registration_trends(self, admin_client, create_user):
        """Test returns user registration counts by month"""
        create_user(email='user1@example.com')
        create_user(email='user2@example.com')

        response = admin_client.get('/api/statistics/customers-growth/')
    ...
    def test_returns_period_and_count(self, admin_client, create_user):
        """Test each entry has period and count"""
        create_user(email='user1@example.com')
    ...
    def test_ordered_by_period(self, admin_client, create_user):
...
class TestComparisonStatsView:
    ...
    def test_returns_orders_and_requests_comparison(self, admin_client, create_order):
        ...
        response = admin_client.get('/api/statistics/order-request-comparison/')

        assert response.status_code == status.HTTP_200_OK
        assert 'orders' in response.data
        assert 'requests' in response.data

    def test_orders_have_period_and_count(self, admin_client, create_order):
    ...
    def test_requests_have_period_and_count(self, admin_client):
    ...
    def test_only_last_180_days(self, admin_client, create_order):
    ...
    def test_empty_data_returns_empty_lists(self, admin_client):
