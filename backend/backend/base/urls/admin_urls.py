...
from base.views.admin_views import AdminLoginView, TranslationView, CustomerListView, RequestsView, GlobalMessagesView, TranslateText, TranslationsView, CreateTranslationView
